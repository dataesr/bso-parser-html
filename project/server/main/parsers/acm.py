...
def parse_authors(soup):
    ...
    if pill_elem:
        for aut_elem in pill_elem.find_all(class_="author-info"):
            ...
            if aut_link and 'href' in aut_link.attrs:
                ...
                author['full_name'] = "{} {}".format(author['first_name'], author['last_name'])
    ...
    #for aut_elem in soup.find_all(class_="auth-info") + :
    #    author = {}
    #    current_affiliations = []
    #    name_elem = aut_elem.find(class_="auth-name")
    #    if name_elem:
    #        author["full_name"] = get_clean_text(name_elem)
    #    aff_elem = aut_elem.find(class_="auth-institution")
    #    if aff_elem:
    #        aff_name = get_clean_text(aff_elem)
    #        current_aff = {"name": aff_name}
    #        if current_aff not in affiliations:
    #            affiliations.append(current_aff)
